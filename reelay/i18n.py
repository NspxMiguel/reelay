...
STRINGS = {
    "en": {
        ...
        "gaps": "Incomplete: {n} section(s) of the audio failed to transcribe, starting at {times}. The text below skips them.",
    ...
    "pt": {
        ...
        "gaps": "Incompleta: {n} trecho(s) do audio falharam na transcricao, a partir de {times}. O texto abaixo pula esses trechos.",
